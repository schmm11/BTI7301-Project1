...
public abstract class Config {
	...
	public final static int T_HEALTH = 150;				// Gesundheit
	...
	public static final double PH_PHASERDAMAGE = 15.0;	// Schaden Phaser 15
	
	//Modul PhaserBIG PB_
	public static final int PB_DELAY = 100;				// AttackSpeed
	public static final double PB_PHASERSPEED = 6.0;	// Geschwindigkeit Phaser 
	public static final double PB_PHASERDAMAGE = 5.0;	// Schaden Phaser 
